...
import 'constants/dummy_categories.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        CategoryMealsScreen.ROUTE_NAME: (ctx) => CategoryMealsScreen(_availableMeals),
        MealDetailScreen.ROUTE_NAME: (ctx) => MealDetailScreen( _isMealFavorite, _toggleFavorite),
